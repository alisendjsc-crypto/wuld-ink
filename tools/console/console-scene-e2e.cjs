...
t("scene js loads after the shell sextet", page.indexOf("console-scene.js?v=K249") > page.indexOf("console.js?v=K273"));
t("sigil js loads after prng, before the shell console (K269)", page.indexOf("console-sigil.js?v=K269") > page.indexOf("console-prng.js?v=K235") && page.indexOf("console-sigil.js?v=K269") < page.indexOf("console.js?v=K273"));
t("fx js loads after sigil, before the shell console (K273)", page.indexOf("console-fx.js?v=K273") > page.indexOf("console-sigil.js?v=K269") && page.indexOf("console-fx.js?v=K273") < page.indexOf("console.js?v=K273"));
t("fx css include at ?v=K273, after console.css", (page.match(/console-fx\.css\?v=K273"/g) || []).length === 1 && page.indexOf("console-fx.css?v=K273") > page.indexOf("console.css?v=K235"));
...
t("shell sextet held (fx+console K273; engine K267; sigil K269; prng/css K235)", ["console.css?v=K235", "console-prng.js?v=K235", "console-engine.js?v=K267", "console-sigil.js?v=K269", "console-fx.css?v=K273", "console-fx.js?v=K273", "console.js?v=K273"]
  .every(s => (page.split(s).length - 1) === 1) && page.indexOf("console-engine.js?v=K265") < 0 && page.indexOf("console.js?v=K235") < 0 && page.indexOf("console.js?v=K267") < 0 && page.indexOf("console.js?v=K269") < 0);
