...
corpus `src/components/omega-corpus-mrgrey.json` · engine `src/components/yurei-oracle.js` · entries 189 · patterns 1076 · fresh Matcher per probe · measure-only
...
- Self-match (control): 99.07% — every failure is a declared collision or the floor arbitrating with itself; undeclared steals: 0 (§3).
- Ambiguity: 9 declared collisions; 1 true coin flips (score-tied, decided by alphabetical id: `hi`); 17 score ties decided by matched length, i.e. the specificity rule working (§4).
...
- Brittleness: `contains` forms survive a leading filler 99.8% and a trailing one 99.8%; `exact` forms survive a leading filler 1%; contraction expansion survives 100%; word order 3.1%; one-edit typos ≈1% (§6).
- Subject coverage: 82 library objections, 53 signed; 9 signed objections that no library phrasing or keyword reaches; 27 signed objections with deflecting title phrasings (candidate triggers); 6 cross-position landings (§7).
...
## 3 Self-match (control) — 99.07% (1066/1076)
...
Score-tied forms (distinct): 18 — 17 decided by matched length (the specificity rule: the longer form wins over the shorter one it contains; deterministic, and the intended behaviour), 1 decided by alphabetical id (true coin flips). Winning by a margin of 2 or less: 91.
...
|---|---|--:|--:|--:|--:|--:|
| contract | contains | 97 | 93.8 | 6 | 0 | 0 |
| contract | exact | 5 | 80 | 1 | 0 | 0 |
| ctl-apostrophe | contains | 12 | 100 | 0 | 0 | 0 |
| ctl-punct | contains | 938 | 100 | 0 | 0 | 0 |
| ctl-punct | exact | 98 | 100 | 0 | 0 | 0 |
| ctl-space | contains | 938 | 100 | 0 | 0 | 0 |
| ctl-space | exact | 98 | 100 | 0 | 0 | 0 |
| ctl-upper | contains | 938 | 100 | 0 | 0 | 0 |
| ctl-upper | exact | 98 | 100 | 0 | 0 | 0 |
| expand | contains | 12 | 100 | 0 | 0 | 0 |
| hyphen | contains | 835 | 100 | 0 | 0 | 0 |
| hyphen | exact | 16 | 100 | 0 | 0 | 0 |
| lead | contains | 7504 | 99.8 | 0 | 14 | 0 |
| lead | exact | 784 | 1 | 761 | 15 | 0 |
| order | contains | 834 | 3.1 | 731 | 77 | 0 |
| order | exact | 16 | 0 | 16 | 0 | 0 |
| plural | contains | 936 | 2 | 848 | 69 | 0 |
| plural | exact | 98 | 0 | 98 | 0 | 0 |
| trail | contains | 3752 | 99.8 | 0 | 6 | 0 |
| trail | exact | 392 | 1 | 383 | 5 | 0 |
| typo-del | contains | 928 | 1 | 883 | 36 | 0 |
| typo-del | exact | 72 | 0 | 72 | 0 | 0 |
| typo-dup | contains | 928 | 0.9 | 884 | 36 | 0 |
| typo-dup | exact | 72 | 0 | 72 | 0 | 0 |
| typo-swap | contains | 928 | 4.4 | 851 | 36 | 0 |
| typo-swap | exact | 72 | 9.7 | 65 | 0 | 0 |

Wrong-answer mutants (a mutated form landing on a DIFFERENT non-deflection entry): 294, of which 268 are NESTED FALLBACKS — the broken form still contains a shorter form of the entry it fell to. The catch-alls:
...
| library-title | 274 | 126 | 21 | 25 | 97 | 2 | 3 |
...
Signed objections that NO library phrasing or keyword reaches: `ableist-objection`, `boonin-critique`, `contractualism-scanlon`, `extinction-culture`, `harman-benign-creation`, `meaning-through-suffering`, `non-identity-problem`, `violence-as-reductio`, `why-not-suicide`. Cross-position landings: 6.
