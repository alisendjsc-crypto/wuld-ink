...
corpus `src/components/omega-corpus-mrgrey.json` · engine `src/components/yurei-oracle.js` · entries 189 · patterns 1108 · fresh Matcher per probe · measure-only
...
- Self-match (control): 99.10% — every failure is a declared collision or the floor arbitrating with itself; undeclared steals: 0 (§3).
- Ambiguity: 9 declared collisions; 1 true coin flips (score-tied, decided by alphabetical id: `hi`); 20 score ties decided by matched length, i.e. the specificity rule working (§4).
...
- Brittleness: `contains` forms survive a leading filler 99.8% and a trailing one 99.8%; `exact` forms survive a leading filler 1.1%; contraction expansion survives 85.7%; word order 3.4%; one-edit typos ≈0.9% (§6).
- Subject coverage: 82 library objections, 53 signed; 4 signed objections that no library phrasing or keyword reaches; 7 signed objections with deflecting title phrasings (candidate triggers); 9 cross-position landings (§7).
- Help: 18/32 help-shaped inputs deflect (§8).
- Dynamics: a rephrase of the same response entry within the 8-turn dampening window deflects for 133/182 entries (§9).
...
## 3 Self-match (control) — 99.10% (1098/1108)
...
Score-tied forms (distinct): 21 — 20 decided by matched length (the specificity rule: the longer form wins over the shorter one it contains; deterministic, and the intended behaviour), 1 decided by alphabetical id (true coin flips). Winning by a margin of 2 or less: 98.
...
| `pos-just-edgy-01` | `you were edgy` | `pos-just-edgy-01` | `mg-hostile-02` | matched length (specificity) | ok |
...
| `pos-marxist-materialist-02` | `the marxist objection` | `pos-marxist-materialist-02` | `pos-marxist-materialist-01` | matched length (specificity) | ok |
...
| `pos-violence-as-reductio-02` | `your view led to violence` | `pos-violence-as-reductio-02` | `mg-stance-bait-01` | matched length (specificity) | ok |
| `pos-ableist-objection-01` | `your view is ableist` | `pos-ableist-objection-01` | `mg-stance-bait-01` | matched length (specificity) | ok |
| `pos-ableist-objection-01` | `your view was ableist` | `pos-ableist-objection-01` | `mg-stance-bait-01` | matched length (specificity) | ok |
...
| `pos-ableist-objection-02` | `your view devalued the disabled` | `pos-ableist-objection-02` | `mg-stance-bait-01` | matched length (specificity) | ok |
| `pos-joy-outweighs-harms-02` | `my life is net positive` | `pos-joy-outweighs-harms-02` | `pos-joy-outweighs-harms-01` | matched length (specificity) | ok |
| `pos-joy-outweighs-harms-02` | `my life was net positive` | `pos-joy-outweighs-harms-02` | `pos-joy-outweighs-harms-01` | matched length (specificity) | ok |
...
|---|---|--:|--:|--:|--:|--:|
| contract | contains | 99 | 93.9 | 6 | 0 | 0 |
| contract | exact | 5 | 80 | 1 | 0 | 0 |
| ctl-apostrophe | contains | 14 | 100 | 0 | 0 | 0 |
| ctl-punct | contains | 967 | 100 | 0 | 0 | 0 |
| ctl-punct | exact | 101 | 100 | 0 | 0 | 0 |
| ctl-space | contains | 967 | 100 | 0 | 0 | 0 |
| ctl-space | exact | 101 | 100 | 0 | 0 | 0 |
| ctl-upper | contains | 967 | 100 | 0 | 0 | 0 |
| ctl-upper | exact | 101 | 100 | 0 | 0 | 0 |
| expand | contains | 14 | 85.7 | 2 | 0 | 0 |
| hyphen | contains | 864 | 100 | 0 | 0 | 0 |
| hyphen | exact | 16 | 100 | 0 | 0 | 0 |
| lead | contains | 7736 | 99.8 | 0 | 14 | 0 |
| lead | exact | 808 | 1.1 | 784 | 15 | 0 |
| order | contains | 863 | 3.4 | 755 | 79 | 0 |
| order | exact | 16 | 0 | 16 | 0 | 0 |
| plural | contains | 965 | 2.1 | 875 | 70 | 0 |
| plural | exact | 101 | 0 | 101 | 0 | 0 |
| trail | contains | 3868 | 99.8 | 0 | 6 | 0 |
| trail | exact | 404 | 1 | 395 | 5 | 0 |
| typo-del | contains | 957 | 0.9 | 912 | 36 | 0 |
| typo-del | exact | 75 | 0 | 75 | 0 | 0 |
| typo-dup | contains | 957 | 0.8 | 913 | 36 | 0 |
| typo-dup | exact | 75 | 0 | 75 | 0 | 0 |
| typo-swap | contains | 957 | 4.4 | 879 | 36 | 0 |
| typo-swap | exact | 75 | 9.3 | 68 | 0 | 0 |

Wrong-answer mutants (a mutated form landing on a DIFFERENT non-deflection entry): 297, of which 270 are NESTED FALLBACKS — the broken form still contains a shorter form of the entry it fell to. The catch-alls:

| landing entry | wrong answers | nested fallbacks | via form |
|---|--:|--:|---|
| `mg-topical-deflect-01` | 184 | 182 | consent x73, suffering x52, asymmetry x30, birth x10, nihilism x7, harm x7, children x4, nonexistence x1 |
| `mg-stance-bait-01` | 26 | 26 | your view x24, do you believe x1, what do you think x1 |
| `pos-non-identity-problem-01` | 24 | 24 | parfit x24 |
| `mg-hostile-02` | 14 | 14 | edgy x14 |
...
| `mg-nav-library-01` | 3 | 0 | objections x2, arguments x1 |
| `mg-stance-bait-02` | 3 | 2 | your philosophy x2, are you a nihilist x1 |
| `pos-joy-outweighs-harms-01` | 2 | 2 | net positive x2 |
...
| `pos-just-edgy-01` | `you were being edgy` | order | `were you being edgy` | `mg-hostile-02` | `edgy` | yes |
| `pos-just-edgy-01` | `you were being edgy` | typo-del | `you were beng edgy` | `mg-hostile-02` | `edgy` | yes |
| `pos-just-edgy-01` | `you were being edgy` | typo-swap | `you were benig edgy` | `mg-hostile-02` | `edgy` | yes |
| `pos-just-edgy-01` | `you were being edgy` | typo-dup | `you were beiing edgy` | `mg-hostile-02` | `edgy` | yes |
| `pos-just-edgy-01` | `you were edgy` | order | `were you edgy` | `mg-hostile-02` | `edgy` | yes |
| `pos-just-edgy-01` | `you were edgy` | typo-del | `you wee edgy` | `mg-hostile-02` | `edgy` | yes |
| `pos-just-edgy-01` | `you were edgy` | typo-swap | `you weer edgy` | `mg-hostile-02` | `edgy` | yes |
| `pos-just-edgy-01` | `you were edgy` | typo-dup | `you werre edgy` | `mg-hostile-02` | `edgy` | yes |
...
| heading | 206 | 181 | 17 | 7 | 0 | 0 | 1 |
| library-title | 274 | 96 | 21 | 25 | 127 | 2 | 3 |
| page | 44 | 28 | 14 | 1 | 0 | 0 | 1 |
| void | 25 | 24 | 1 | 0 | 0 | 0 | 0 |
| library-keyword | 696 | 615 | 12 | 30 | 30 | 6 | 3 |
...
| `ai-fear` | yes | 4 | 9 | 4 | 0 | 0 | 0 | 9 |
| `animals-reproduce` | yes | 2 | 7 | 4 | 0 | 0 | 0 | 5 |
| `antinatalism-misanthropic` | yes | 3 | 9 | 6 | 0 | 0 | 0 | 6 |
| `benatar-asymmetry-attack` | yes | 2 | 6 | 1 | 0 | 2 | 2 | 3 |
| `bitter-childhood` | yes | 2 | 9 | 5 | 0 | 0 | 0 | 6 |
| `boonin-critique` | yes | 3 | 8 | 1 | 0 | 2 | 2 | 6 |
| `bradley-no-subject` | yes | 2 | 8 | 1 | 0 | 1 | 0 | 8 |
| `care-ethics` | yes | 5 | 12 | 5 | 0 | 0 | 0 | 12 |
| `change-your-mind` | yes | 3 | 8 | 3 | 1 | 0 | 0 | 7 |
| `cherry-picking-worst` | yes | 3 | 9 | 4 | 0 | 0 | 0 | 8 |
| `consent-both-ways` | yes | 1 | 4 | 2 | 0 | 0 | 2 | 1 |
| `consent-incoherent` | yes | 3 | 5 | 1 | 0 | 1 | 3 | 3 |
| `contractualism-scanlon` | yes | 3 | 9 | 1 | 1 | 3 | 0 | 7 |
| `economy-population` | yes | 2 | 9 | 2 | 1 | 0 | 0 | 8 |
| `evolution-purpose` | yes | 3 | 8 | 3 | 0 | 0 | 0 | 8 |
| `extinction-culture` | yes | 4 | 8 | 3 | 0 | 2 | 0 | 7 |
| `future-solve` | yes | 2 | 7 | 2 | 0 | 0 | 1 | 6 |
| `gods-plan` | yes | 3 | 13 | 2 | 0 | 0 | 4 | 10 |
| `happiness-is-choice` | yes | 6 | 12 | 9 | 0 | 0 | 0 | 9 |
| `harman-benign-creation` | yes | 3 | 7 | 1 | 1 | 3 | 0 | 5 |
| `joy-outweighs-harms` | yes | 6 | 8 | 8 | 0 | 0 | 1 | 5 |
| `just-depressed` | yes | 3 | 8 | 2 | 0 | 0 | 4 | 5 |
| `just-edgy` | yes | 3 | 9 | 3 | 0 | 0 | 3 | 6 |
| `life-gift` | yes | 3 | 7 | 3 | 0 | 0 | 0 | 7 |
| `love-beauty-art` | yes | 3 | 9 | 4 | 0 | 1 | 0 | 7 |
| `luxury-belief` | yes | 4 | 11 | 4 | 1 | 1 | 0 | 9 |
| `marxist-materialist` | yes | 4 | 12 | 4 | 0 | 0 | 0 | 12 |
| `masochist-counterexample` | yes | 8 | 13 | 9 | 0 | 0 | 1 | 11 |
| `meaning-through-suffering` | yes | 4 | 9 | 0 | 2 | 0 | 1 | 10 |
| `moral-progress` | yes | 3 | 8 | 3 | 0 | 0 | 0 | 8 |
| `most-people-happy` | yes | 2 | 8 | 2 | 0 | 0 | 0 | 8 |
| `natural-reproduce` | yes | 2 | 6 | 3 | 0 | 0 | 0 | 5 |
| `next-person-cure-cancer` | yes | 2 | 8 | 4 | 0 | 0 | 0 | 6 |
| `nihilism-label` | yes | 2 | 6 | 2 | 0 | 0 | 1 | 5 |
| `non-identity-problem` | yes | 3 | 8 | 1 | 0 | 2 | 1 | 7 |
| `overpopulation-addressed` | yes | 3 | 7 | 2 | 0 | 0 | 2 | 6 |
| `pinker-better-world` | yes | 4 | 6 | 4 | 0 | 0 | 0 | 6 |
| `playing-god` | yes | 3 | 4 | 3 | 0 | 0 | 1 | 3 |
| `policy-proposal` | yes | 2 | 9 | 2 | 0 | 0 | 0 | 9 |
...
| `social-contract` | yes | 3 | 7 | 3 | 0 | 0 | 2 | 5 |
| `speak-for-everyone` | yes | 3 | 7 | 5 | 0 | 0 | 0 | 5 |
| `suffering-as-meaning` | yes | 5 | 7 | 5 | 0 | 0 | 1 | 6 |
| `suffering-makes-human` | yes | 3 | 9 | 3 | 0 | 0 | 0 | 9 |
| `survivor-testimony` | yes | 3 | 9 | 1 | 0 | 0 | 0 | 8 |
...
Signed objections that NO library phrasing or keyword reaches: `ableist-objection`, `meaning-through-suffering`, `violence-as-reductio`, `why-not-suicide`. Cross-position landings: 9.
...
| `harman-benign-creation` | `harmans benign creation` | `creating a life worth living is permissible->mg-worth-living-01` |
...
| `social contract` | `contractualism-scanlon` | `pos-social-contract-01` |
| `civilization` | `economy-population` | `pos-extinction-culture-01` |
| `net positive` | `harman-benign-creation` | `pos-joy-outweighs-harms-01` |
...
| heading | _… 141 more in the JSON_ |
| library-keyword | _… 575 more in the JSON_ |
...
- Rephrase within the 8-turn dampening window (form A then form B of the same entry, one matcher): 182 entries → same entry 29 · deflection 133 · a different entry 20.
