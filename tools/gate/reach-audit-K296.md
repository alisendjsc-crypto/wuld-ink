...
|--:|---|--:|--:|--:|--:|--:|--:|--:|---|
| 1 | `/donations/` | 1595 | **1.89** | 1595 | 1.89 | 1465 | 1.63 | 3975 | `main#main > section.donations-section > div.donations-platforms > article.donations-platform` |
| 2 | `/gallery/` | 1568 | **1.86** | 2841 | 3.37 | 1193 | 1.33 | 11826 | `div#gallery-cat-grid > a.gallery-cat-card` |
| 3 | `/recommendations/` | 1509 | **1.79** | 2363 | 2.80 | 1197 | 1.33 | 21467 | `main#main > section.rec-section` |
| 4 | `/book/` | 1462 | **1.73** | 1462 | 1.73 | 1608 | 1.79 | 6740 | `main#main > article.page > section.book-section` |
| 5 | `/archive/` | 1282 | **1.52** | 11689 | 13.85 | 1639 | 1.82 | 17039 | `body > main.archive-page > section.archive-section` |
| 6 | `/music/` | 1249 | **1.48** | 1249 | 1.48 | 2098 | 2.33 | 2073 | `article.music-card > div.music-meta > details.music-tracklist > ol > li` |
| 7 | `/gallery/original-character/` | 1163 | **1.38** | 1163 | 1.38 | 1010 | 1.12 | 5149 | `section#gallery-grid > article.gallery-plate.gallery-plate-withheld` |
| 8 | `/gallery/the-wrong-thing/` | 1099 | **1.30** | 1099 | 1.30 | 992 | 1.10 | 2599 | `section#gallery-grid > article.gallery-plate.gallery-plate-withheld` |
| 9 | `/changelog/` | 1058 | **1.25** | 1058 | 1.25 | 963 | 1.07 | 40356 | `ol#changelog-list > li.changelog-entry` |
| 10 | `/console/` | 1050 | **1.24** | 1050 | 1.24 | 1090 | 1.21 | 2025 | `div#console-app > div.con-term.con-fx.con-fx-low > div.con-ctrl > button.con-btn` |
| 11 | `/gallery/gore/` | 1035 | **1.23** | 1035 | 1.23 | 992 | 1.10 | 2748 | `section#gallery-grid > article.gallery-plate.gallery-plate-withheld` |
| 12 | `/void-engine/` | 1031 | **1.22** | 2162 | 2.56 | 531 | 0.59 | 101098 | `div.app > div.panel > div.pb.col > div.ctrl > select` |
| 13 | `/gallery/mascot-yurei/` | 982 | **1.16** | 982 | 1.16 | 936 | 1.04 | 2630 | `section#gallery-grid > article.gallery-plate.gallery-plate-withheld` |
| 14 | `/gallery/other/` | 982 | **1.16** | 982 | 1.16 | 936 | 1.04 | 2630 | `section#gallery-grid > article.gallery-plate.gallery-plate-withheld` |
| 15 | `/gallery/workshop/` | 973 | **1.15** | 1599 | 1.89 | 884 | 0.98 | 16834 | `div#gallery-chips > button.gallery-chip` |
| 16 | `/gallery/main-character/` | 945 | **1.12** | 1943 | 2.30 | 873 | 0.97 | 15383 | `div#gallery-chips > button.gallery-chip` |
| 17 | `/frame/` | 864 | **1.02** | 864 | 1.02 | 1413 | 1.57 | 4678 | `main#main > article.page > section.frame-section` |
...
| 33 | `/essays/alogically-is/` | 468 | **0.55** | 468 | 0.55 | 561 | 0.62 | 18489 | `main#main > article.essay > header.essay-header > div.mode-toggle > button.mode-toggle-btn` |
...
phone first-group  >=2.00 screens: 0 · 1.50-1.99: 5 · 1.00-1.49: 12 · <1.00: 40 · no group (prose/portal): 13 of 70
