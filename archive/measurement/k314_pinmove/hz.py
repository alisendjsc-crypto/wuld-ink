...
SUPPRESS = "try{localStorage.setItem('wz-tour-done','1');['library','map','dep','map1','examples','rwe','coda','index','wing'].forEach(function(k){localStorage.setItem('wz-tour:'+k,'1')})}catch(e){}"
