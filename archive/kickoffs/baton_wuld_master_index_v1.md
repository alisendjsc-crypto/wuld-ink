# WULD Master Index — Project Reference v1.0

> Compiled 2026-05-02 from project-baton_8.md + session memory. Reference doc for any incoming Claude. Read META + QUICK INDEX first; consult specific blocks and appendices on demand.
...
5. **Add a PRIORITY field** distinct from PULSE — pulse measures heat, priority measures attention-deserving-ness (which can diverge: a stalled-but-important project has low pulse, high priority).

---

## CHANGELOG / TRANSPARENCY

Changes from `project-baton_8.md`:
...
**Did NOT add:** detailed personal/psychological context (mental health history, sadistic-inclination self-disclosure, specific research interests around extreme ideologies). These are present in chat memory but feel out of scope for a project-reference document and over-discloseable on your behalf without explicit consent. Add yourself if relevant.

**Sourcing:** Appendix A drawn from a 2026-04-14 corpus-organization session. Appendix D drawn from the same session. Appendices B/C/E/F/G drawn from cross-session memory (multiple project sessions Apr 2026). Appendix H is editorial recommendation, not historical content.

**Confidence:** High on appendix content (multiple corroborating sessions). Medium on PULSE numbers — they are your numbers from the baton; I haven't recalibrated.
